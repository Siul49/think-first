---
name: skill-creator
description: 새로운 Antigravity 스킬을 작성할 때 자동 활성화됩니다. SKILL.md 표준 형식과 리소스 구조를 가이드하여 일관된 스킬을 생성합니다. "스킬 만들어줘", "커맨드 추가", "새 스킬" 요청에 반응합니다.
---
...
- `.agent/skills/` 하위에 새 디렉토리 생성이 필요한 경우
- 기존 스킬의 구조 개선/재작성 요청
...
5. **회고**: 작업 완료 후 사용자 회고 → `.agent/reflections/YYYY-MM-DD.md`에 기록
...
- `.agent/skills/{name}/resources/execution-protocol.md`
- [추가 리소스 파일 목록]
