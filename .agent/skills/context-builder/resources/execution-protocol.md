...
1. GEMINI.md 존재 여부 확인
2. `.agent/context/` 디렉토리 확인
...
우선순위:
1. GEMINI.md — 없으면 생성, 있으면 보강 제안
2. `.agent/context/architecture.md` — 디렉토리 구조 + 역할
3. `.agent/context/tech-stack.md` — 감지된 기술 스택
4. `.agent/context/conventions.md` — 코드 스타일 규칙

### 생성 규칙
- 자동 감지된 정보만 기입
- 불확실한 부분은 `[확인 필요]` 표시
- GEMINI.md의 기존 내용은 절대 삭제하지 않음
- 토큰 효율을 위해 간결하게 작성
