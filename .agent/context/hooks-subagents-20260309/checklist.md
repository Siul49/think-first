...
- [x] `.agent/hooks/` 디렉토리 생성
- [x] `block-dangerous-commands.sh` — 위험 명령 차단
- [x] `checklist-reminder.sh` — 복합 작업 체크리스트 리마인더

## Phase 2: Settings에 Hooks 등록

- [x] `.agent/settings.json` 생성 (hooks 섹션)
- [x] PreToolUse(Bash): 위험 명령 차단
- [x] Stop: 체크리스트 리마인더

## Phase 3: Subagents 작성

- [x] `.agent/agents/code-reviewer.md`
- [x] `.agent/agents/task-planner.md`
- [x] `.agent/agents/test-runner.md`
- [x] `.agent/agents/doc-writer.md`
